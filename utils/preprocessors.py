...
class CSVPreprocessor:
    ...
    def preprocess(self, preprocess_level='word', val_size=0.1):
        ...
        if self.split_train_test:
            ...
            # return self.preprocess_train_test(preprocess_level, val_size)
        else:
            return self.preprocess_all(preprocess_level, val_size)
    ...
    def preprocess_train_test(self, preprocess_level='word', val_size=0.1):
    ...
    def preprocess_all(self, preprocess_level='word', val_size=0.1):
